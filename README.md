...
| [Knowledge MCP Server](docs/product/knowledge/README.md) | A centralized MCP server exposing a structured knowledge directory as resources, prompts, skills, commands, and agent definitions. Serves as the single source of truth for all reusable AI assets across the platform — eliminating local copies and providing governed access over the Model Context Protocol. | `docs/product/knowledge/` |
