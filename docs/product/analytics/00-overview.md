...
- [Appendix](./06-text-to-sql-antipattern.md) — Text-to-SQL and Semantic Analytics: structural failure modes and the complementary architecture
- [Roadmap](./07-roadmap.md) — Planned enhancements beyond the current release
